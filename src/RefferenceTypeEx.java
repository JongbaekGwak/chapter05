...
public class RefferenceTypeEx {
	...
	public static void main(String[] args) {
		...
		String str2 = "참조타입";	//	str1 이 선언되면서 저장한 데이터의 주소만 가져옴
...
//		String 데이터 타입은 기본 타입처럼 사용하는 데이터 타입이므로 예외를 워서 기본타입처럼 new 키워드 없이도 사용할 수 있도록 함
		
//		String 타입의 변수 2개 이상을 동일한 코드 블럭 내에서 선언하고 동일한 데이터를 new 키워드 없이 대입연산자만 사용하여
//		저장하였을 경우 먼저 선언된 String 타입의 변수에만 new 키워드가 사용되고, 나중에 선언된 String 타입의 변수에는
//		기존에 선언된 String 타입의 변수가 가지고 있는 메모리 주소를 대입 함
...
//		String 데이터 타입은 클래스로 만들어져 있기 때문에 여러가지 메서드가 존재함
		...
		if (str3 == str4) {
			System.out.println("변수 srt3 : " + str3 + "\n변수 str4 : " + str4);
